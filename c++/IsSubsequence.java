 ...
 *
 * You may assume that there is only lower
 * case English letters in both s and t.
 * t is potentially a very long
 * (length ~= 500,000) string, and s is
 * a short string (<=100).
 *
 ...
 * relative positions of the remaining
