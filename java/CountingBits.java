 ...
 * with run time O(n*sizeof(integer)). But can
 * you do it in linear time O(n) /possibly in
 * a single pass?
 * Space complexity should be O(n).
 * Can you do it like a boss? Do it without using
 * any builtin function like __builtin_popcount
 * in c++ or in any other language.
 * Hint:
 *
 * You should make use of what you have produced already.
 * Divide the numbers in ranges like [2-3],
 * [4-7], [8-15] and so on. And try to generate
